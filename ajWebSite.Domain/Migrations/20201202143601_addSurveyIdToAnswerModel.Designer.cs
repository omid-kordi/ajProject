...
{
    [DbContext(typeof(DB))]
    [Migration("20201202143601_addSurveyIdToAnswerModel")]
    partial class addSurveyIdToAnswerModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.survey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("surveyRunningId");
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.surveyQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.surveyQuestionAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ajWebSite.Domain.ajWebSite.salon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.comment", b =>
                {
                    b.HasOne("ajWebSite.Domain.Common.comment", "parent")
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.surveyQuestion", b =>
                {
                    b.HasOne("ajWebSite.Domain.Common.survey", "survey")
                        .WithMany("questions")
            ...
            modelBuilder.Entity("ajWebSite.Domain.Common.surveyQuestionAnswer", b =>
                {
                    b.HasOne("ajWebSite.Domain.Common.surveyQuestion", "question")
                        .WithMany("answers")
